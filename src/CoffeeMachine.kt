...
class CoffeeMachine {
    ...
    private fun buy() {
        ...
        try {
            ...
            when (item) {
                "1" -> calculateEspressoCostAndMaterialAvailable()
    ...
    private fun fill() {
        ...
        try {
            ...
            quantityOfWaterAvailable += readln().toInt()

            println("Write how many ml of milk you want to add: ")
            quantityOfMilkAvailable += readln().toInt()

            println("Write how many grams of coffee beans you want to add: ")
            quantityOfCoffeeBeansAvailable += readln().toInt()

            println("Write how many disposable cups you want to add:")
            quantityOfDisposableCupsAvailable += readln().toInt()
    ...
    private fun calculateEspressoCostAndMaterialAvailable() {
    ...
    private fun calculateLatteCostAndMaterialsAvailable() {
        val quantityOfCoffeeRequired = 1
    ...
    private fun calculateCappuccinoCostAndMaterialsAvailable() {
        val quantityOfCoffeeRequired = 1
    ...
    private fun printAvailableStock() {
        println()
    ...
    private fun printMessage(isMaterialSufficient: Boolean, material: String = "") {
